declare type StrictNullChecksWrapper<Name extends string, Type> = undefined extends null
  ? `strictNullChecks must be true in tsconfig to use ${Name}`
  : Type;
declare type UnionToIntersection<U> = (U extends any ? (_: U) => void : never) extends (
  _: infer I
) => void
  ? I
  : never;
...
export declare type PartialSchema<T> = StrictNullChecksWrapper<
  'PartialSchema',
  UncheckedPartialSchema<T>
>;
declare type JSONType<T extends string, IsPartial extends boolean> = Exclude<
  (IsPartial extends true
    ? T | [T, 'null'] | ['null', T] | undefined
    : T | [T, 'null'] | ['null', T]),
  ['null' | 'null']
>;
...
export declare type JSONSchemaType<T> = StrictNullChecksWrapper<
  'JSONSchemaType',
...
export declare type PropertiesSchema<T> = StrictNullChecksWrapper<
  'PropertiesSchema',
  UncheckedPropertiesSchema<T>
>;
...
export declare type RequiredMembers<T> = StrictNullChecksWrapper<
  'RequiredMembers',
