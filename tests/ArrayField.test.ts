...
describe('ArrayField', () => {
  ...
  describe('Unsupported array schema', () => {
    it('should warn on missing items descriptor', () => {
      const { container } = createFormComponent({ schema: { type: 'array' } });

      expect(container.querySelector('.field-array > .unsupported-field').textContent).to.contain(
  ...
  describe('Malformed nested array formData', () => {
    ...
    it('should contain no field in the list when nested array formData is explicitly null', () => {
      ...
      expect(container.querySelectorAll('.field-string')).to.have.length.of(0);
    });
  });
  ...
  describe('List of inputs', () => {
    ...
    it('should render a description', () => {
      ...
      const description = container.querySelector('fieldset > .field-description');
    ...
    it('should render a customized title', () => {
      ...
      expect(container.querySelector('fieldset > #custom').textContent).to.eql('my list');
    });
    ...
    it('should pass uiSchema to normal array field', () => {
      ...
      expect(container.querySelectorAll("input[placeholder='Placeholder...']")).to.have.length.of(2);
    });
    ...
    it('should pass rawErrors down to custom array field templates', () => {
      ...
      const matches = container.querySelectorAll('#custom');
      expect(matches).to.have.length.of(1);
      expect(matches[0].textContent).to.eql('should NOT have fewer than 2 items');
    });
    ...
    it('should not have an add button if addable is false', () => {
      ...
      expect(container.querySelector('.array-item-add button')).to.be.null;
    });
    ...
    it('should assign new keys/ids when clicking the add button', () => {
      ...
      expect(container.querySelector('.array-item').hasAttribute(ArrayKeyDataAttr)).to.be.true;
    });
    ...
    it('should add a field when clicking add button even if event is not passed to onAddClick', () => {
      ...
      expect(container.querySelector('.array-item')).not.to.be.null;
    });
    ...
    it('should retain existing row keys/ids when adding new row', () => {
      ...
      const startRows = container.querySelectorAll('.array-item');
      ...
      const endRows = container.querySelectorAll('.array-item');
    ...
    it('should allow inserting anywhere in list', () => {
      ...
      const addBeforeButtons = container.querySelectorAll('.array-item-move-before');
      const addAfterButtons = container.querySelectorAll('.array-item-move-after');
    ...
    it('should mark a non-null array item widget as required', () => {
      ...
      expect(container.querySelector('.field-string input[type=text]').required).eql(true);
    });
    ...
    it('should fill an array field with data', () => {
      ...
      const inputs = container.querySelectorAll('.field-string input[type=text]');
    ...
    it("shouldn't have reorder buttons when list length <= 1", () => {
      const { container } = createFormComponent({ schema, formData: ['foo'] });

      expect(container.querySelector('.array-item-move-up')).eql(null);
      expect(container.querySelector('.array-item-move-down')).eql(null);
    });
    ...
    it('should have reorder buttons when list length >= 2', () => {
      ...
      expect(container.querySelector('.array-item-move-up')).not.eql(null);
      expect(container.querySelector('.array-item-move-down')).not.eql(null);
    });
    ...
    it('should move from first to last in the list', () => {
      ...
      const button = container.querySelector('.item-0 .array-item-move-to-2');
    ...
    it('should not show move up/down buttons if orderable is false', () => {
      ...
      const moveUpBtns = container.querySelector('.array-item-move-up');
      const moveDownBtns = container.querySelector('.array-item-move-down');
    ...
    it('should remove a field from the list', () => {
      ...
      const dropBtns = container.querySelectorAll('.array-item-remove');
    ...
    it('should delete item from list and correct indices', () => {
      ...
      const deleteBtns = container.querySelectorAll('.array-item-remove');
    ...
    it('should not show remove button if removable is false', () => {
      ...
      const dropBtn = container.querySelector('.array-item-remove');
    ...
    it('should force revalidation when a field is removed', () => {
      ...
      expect(container.querySelectorAll('.has-error .error-detail')).to.have.length.of(1);

      const dropBtns = container.querySelectorAll('.array-item-remove');

      Simulate.click(dropBtns[0]);

      expect(container.querySelectorAll('.has-error .error-detail')).to.have.length.of(0);
    });
    ...
    it('should handle cleared field values in the array', () => {
      ...
      const { container, onChange, onError } = createFormComponent({
        liveValidate: true,
        schema,
        formData
      });

      Simulate.change(container.querySelector('#root_1'), {
        target: { value: '' }
      });
    ...
    it('should render enough inputs with proper defaults to match minItems in schema when no formData is set', () => {
      ...
      let inputs = form.container.querySelectorAll('input[type=text]');
    ...
    it('should render an input for each default value, even when this is greater than minItems', () => {
      ...
      const { container } = createFormComponent({ schema: schema });
      const inputs = container.querySelectorAll('input[type=text]');
    ...
    it('should honor given formData, even when it does not meet ths minItems-requirement', () => {
      ...
      const inputs = form.container.querySelectorAll('input[type=text]');
  ...
  describe('Multiple choices list', () => {
    ...
    describe('Select multiple widget', () => {
      ...
      it('should render a select widget with a label', () => {
        ...
        expect(container.querySelector('.field label').textContent).eql('My field');
      });

      it('should render a select widget with multiple attribute', () => {
        const { container } = createFormComponent({ schema });

        expect(container.querySelector('.field select').getAttribute('multiple')).not.to.be.null;
      });
      ...
      it('should fill field with data', () => {
        ...
        const options = container.querySelectorAll('.field select option');
      ...
      it('should pass a label as prop to custom widgets', () => {
        ...
        const matches = container.querySelectorAll('#test');
        expect(matches).to.have.length.of(1);
      ...
      it('should pass uiSchema to multiselect', () => {
        ...
        expect(container.querySelector('option[value=bar]').disabled).to.eql(true);
      });
    });
    ...
    describe('CheckboxesWidget', () => {
      ...
      it('should render the expected number of checkboxes', () => {
        ...
        expect(container.querySelectorAll('[type=checkbox]')).to.have.length.of(3);
      });
      ...
      it('should render the expected labels', () => {
        ...
        const labels = [].map.call(
          container.querySelectorAll('.checkbox label'),
      ...
      it('should handle a change event', () => {
        ...
        Simulate.change(container.querySelectorAll('[type=checkbox]')[0], {
          target: { checked: true }
        });
        Simulate.change(container.querySelectorAll('[type=checkbox]')[2], {
          target: { checked: true }
        });
      ...
      it('should fill field with data', () => {
        ...
        const labels = [].map.call(
          container.querySelectorAll('[type=checkbox]'),
          (container) => container.checked
        );
      ...
      it('should render the widget with the expected id', () => {
        ...
        expect(container.querySelector('.checkboxes').id).eql('root');
      });
      ...
      it('should support inline checkboxes', () => {
        ...
        expect(container.querySelectorAll('.checkbox-inline')).to.have.length.of(3);
      });
      ...
      it('should pass rawErrors down to custom widgets', () => {
        ...
        const matches = container.querySelectorAll('#custom');
        expect(matches).to.have.length.of(1);
        expect(matches[0].textContent).to.eql('should NOT have fewer than 3 items');
      });
  ...
  describe('Multiple files field', () => {
    ...
    it('should render a file widget with multiple attribute', () => {
      ...
      expect(container.querySelector('.field [type=file]').getAttribute('multiple')).not.to.be.null;
    });
    ...
    it('should handle a change event', async () => {
      ...
      Simulate.change(container.querySelector('.field input[type=file]'), {
        target: {
          files: [
    ...
    it('should fill field with data', () => {
      ...
      const li = container.querySelectorAll('.file-info li');
    ...
    it('should render the file widget with the expected id', () => {
      ...
      expect(container.querySelector('input[type=file]').id).eql('root');
    });
    ...
    it('should pass uiSchema to files array', () => {
      ...
      expect(container.querySelector('input[type=file]').accept).eql('.pdf');
    });
    ...
    it('should pass rawErrors down to custom widgets', () => {
      ...
      const matches = container.querySelectorAll('#custom');
      expect(matches).to.have.length.of(1);
      expect(matches[0].textContent).to.eql('should NOT have fewer than 5 items');
    });
  });
  ...
  describe('Nested lists', () => {
    ...
    it('should render two lists of inputs inside of a list', () => {
      ...
      expect(container.querySelectorAll('fieldset fieldset')).to.have.length.of(2);
    });

    it('should add an inner list when clicking the add button', () => {
      const { container } = createFormComponent({ schema });
      expect(container.querySelectorAll('fieldset fieldset')).to.be.empty;

      Simulate.click(container.querySelector('.array-item-add button'));

      expect(container.querySelectorAll('fieldset fieldset')).to.have.length.of(1);
    });
    ...
    it('should pass rawErrors down to every level of custom widgets', () => {
      ...
      const matches = container.querySelectorAll('#custom-error');
      expect(matches).to.have.length.of(2);
      expect(matches[0].textContent).to.eql('should NOT have fewer than 3 items');
      expect(matches[1].textContent).to.eql('should NOT have fewer than 2 items');
    });
  });
  ...
  describe('Fixed items lists', () => {
    ...
    it('should render a fieldset', () => {
      ...
      expect(container.querySelectorAll('fieldset')).to.have.length.of(1);
    });
    ...
    it('should render field widgets', () => {
      const { container } = createFormComponent({ schema });
      const strInput = container.querySelector('fieldset .field-string input[type=text]');
      const numInput = container.querySelector('fieldset .field-number input[type=number]');
    ...
    it('should generate additional fields and fill data', () => {
      ...
      const addInput = container.querySelector('fieldset .field-string input[type=text]');
    ...
    it('should apply uiSchema to additionalItems', () => {
      ...
      const label = container.querySelector('fieldset .field-string label.control-label');
      expect(label.textContent).eql('Custom title*');
    });

    it('should have an add button if additionalItems is an object', () => {
      const { container } = createFormComponent({ schema: schemaAdditional });
      expect(container.querySelector('.array-item-add button')).not.to.be.null;
    });
    ...
    it('[fixed] should pass uiSchema to fixed array', () => {
      ...
      expect(container.querySelectorAll('textarea').length).to.eql(2);
    });
    ...
    describe('operations for additional items', () => {
      ...
      it('should add a field when clicking add button', () => {
        const addBtn = container.querySelector('.array-item-add button');

        Simulate.click(addBtn);

        expect(container.querySelectorAll('.field-string')).to.have.length.of(2);
      ...
      it('should remove array items when clicking remove buttons', () => {
        let dropBtns = container.querySelectorAll('.array-item-remove');
        ...
        dropBtns = container.querySelectorAll('.array-item-remove');
        Simulate.click(dropBtns[0]);

        expect(container.querySelectorAll('.field-string')).to.be.empty;
        sinon.assert.calledWithMatch(onChange.lastCall, {
          formData: [1, 2]
        });
      });
  ...
  describe('Custom Widget', () => {
    it('if it does not contain enums or uniqueItems=true, it should still render the custom widget.', () => {
      ...
      expect(container.querySelectorAll('#custom-select')).to.have.length.of(2);
    });
  ...
  describe('Title', () => {
    ...
    it('should pass field name to TitleField if there is no title', () => {
      ...
      expect(container.querySelector('#title-array')).to.not.be.null;
    });
  ...
  describe("should handle nested 'hideError: true' uiSchema value", () => {
    ...
    it('should render nested error decorated input widgets with the expected ids', () => {
      ...
      const inputs = container.querySelectorAll('.form-group.field-error input[type=text]');
      expect(inputs[0].id).eql('root_foo_0_bar');
    ...
    it('should NOT render nested error decorated input widgets', () => {
      ...
      const inputsNoError = container.querySelectorAll('.form-group.field-error input[type=text]');
